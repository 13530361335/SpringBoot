...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    public static boolean copyDirectoryCover(String srcDirName,
                                             String descDirName, boolean cover) {
        ...
        String descDirNames = descDirName.endsWith(File.separator) ? descDirName : descDirName + File.separator;
